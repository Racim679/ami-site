      ...
      <AnimatedSection className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center text-primary-foreground px-4 max-w-4xl mx-auto">
          ...
          >
            ...
            <AnimatedButton 
              className="border-2 border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary px-8 py-3 rounded-lg text-lg font-semibold transition-colors"
      ...
      <AnimatedSection className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <AnimatedButton 
              className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground px-8 py-3 rounded-lg text-lg font-semibold transition-colors"
              onClick={() => navigate('/nos-biens')}
            >
              Voir nos biens
            </AnimatedButton>
