      ...
      <AnimatedSection className="pb-4 pt-2 bg-background">
        <div className="container mx-auto px-4">
          ...
          duration: 0.6
            ...
            <h2 className="text-4xl md:text-5xl font-bold font-heading mb-3 md:mb-4 text-primary leading-tight tracking-tight lg:text-5xl">Pourquoi choisir AMI Immobilier  </h2>
