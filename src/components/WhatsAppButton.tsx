    ...
    <>
      ...
      <div className="fixed bottom-20 right-5 z-[1000] md:bottom-24 md:right-6">
        <a
          ...
          className="whatsapp-vibrate flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#25d366] rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.4)] transition-all duration-300 text-white hover:scale-110 hover:shadow-[0_6px_30px_rgba(37,211,102,0.6)]"
