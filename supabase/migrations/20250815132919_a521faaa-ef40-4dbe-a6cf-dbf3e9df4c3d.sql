-- Ajouter des contraintes uniques pour permettre ON CONFLICT
ALTER TABLE property_amenities_structured 
ADD CONSTRAINT property_amenities_structured_property_id_unique UNIQUE (property_id);

ALTER TABLE property_security_structured 
ADD CONSTRAINT property_security_structured_property_id_unique UNIQUE (property_id);

ALTER TABLE property_documents_structured 
ADD CONSTRAINT property_documents_structured_property_id_unique UNIQUE (property_id);

-- Maintenant insérer les données d'exemple pour les propriétés existantes
